...
```
>**У HQ-CLI скорее всего другой IPv4 как и логин пользователя**
```ini
[hq]
...
hq-cli ansible_host=192.168.2.5 ansible_user=polzovate ansible_password=P@ssw0rd
...
```
> Точных данных я и сам пока не знаю, но они будут дописаны, расположение данных `/mnt/iso/docker/readme.txt`
```yaml
version: '3'
